    ...
    <div className="min-h-screen">
          ...
          <div className="md:flex md:items-center md:gap-8">
            <div className="md:flex md:items-start md:gap-8 w-full">
              ...
              <div className="md:w-1/2">
                ...
                {/* Buttons removed per request - cafe shown on landing and menu/order actions hidden */}
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link 
            href="/contact"
            className="inline-block px-6 py-3 sm:px-8 sm:py-4 bg-blue-600 text-white text-base sm:text-lg rounded-lg hover:bg-blue-700 transition font-semibold shadow-lg hover:shadow-xl"
          >
            Contact Us
          </Link>
        </div>
