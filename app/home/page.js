    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link 
            href="/contact"
            className="inline-block px-6 py-3 sm:px-8 sm:py-4 bg-emerald-600 text-white text-base sm:text-lg rounded-lg hover:bg-emerald-700 transition font-semibold shadow-lg hover:shadow-xl"
          >
            Contact Us
          </Link>
        </div>
