      ...
      <html>
        <head>
          ...
          <style>
            ...
            .logo { font-size: 20px; color: #3b82f6; font-weight: 700; }
            ...
            .big { font-weight:700; font-size: 18px; color: #3b82f6; }
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
        <div className="text-blue-700 font-bold text-xl p-4 border-b bg-white">Event Reservations</div>
        <div className="overflow-auto" style={{ maxHeight: '400px' }}>
          <table className="min-w-full bg-white">
            <thead className="sticky top-0 z-10 bg-gray-50">
              <tr>
                <th className="p-3 text-left text-blue-700 font-semibold">Type</th>
                <th className="p-3 text-left text-blue-700 font-semibold">Date</th>
                <th className="p-3 text-left text-blue-700 font-semibold">Time</th>
                <th className="p-3 text-left text-blue-700 font-semibold">Guests</th>
                <th className="p-3 text-left text-blue-700 font-semibold">Set</th>
                <th className="p-3 text-right text-blue-700 font-semibold">Total Amount</th>
                <th className="p-3 text-right text-blue-700 font-semibold">Downpayment</th>
                <th className="p-3 text-right text-blue-700 font-semibold">Remaining</th>
                <th className="p-3 text-left text-blue-700 font-semibold">Status</th>
                <th className="p-3 text-center text-blue-700 font-semibold">Actions</th>
              </tr>
            </thead>
            <tbody>
      ...
      <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold mb-6 text-blue-700">Event Calendar</h3>
        ...
        {/* Right: Event Details */}
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold mb-6 text-blue-700">Event Information</h3>
            ...
            {selectedDateBookings.length > 0 ? (
              <div className="space-y-4">
                {selectedDateBookings.map((event) => (
                  <div key={event.id} className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border-l-4 border-blue-600 shadow-sm">
                    <div className="flex justify-between items-start mb-2">
                      <h5 className="font-bold text-gray-800 text-lg">{event.name}</h5>
                      <span className={`px-2 py-1 text-xs rounded-full ${
                        event.status?.toLowerCase() === 'confirmed' ? 'bg-blue-100 text-blue-700' :
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="mt-3 pt-3 border-t border-blue-200">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-bold text-blue-700">{formatCurrency(event.totalCost ?? event.total_cost ?? event.total ?? event.price)}</span>
                        </div>
                      </div>
                    </div>
      ...
      {isModalOpen && selectedEvent && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white text-black p-6 rounded-lg shadow-lg w-full max-w-5xl max-h-[90vh] overflow-y-auto relative">
            ...
            <h2 className="text-2xl font-bold mb-6 text-blue-700 border-b pb-2">{selectedEvent.name}</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Left Column */}
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h3 className="text-lg font-semibold text-blue-700 mb-3">Event Information</h3>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h3 className="text-lg font-semibold text-blue-700 mb-3">Additional Information</h3>
                  <div className="space-y-3 text-sm">
                    <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h3 className="text-lg font-semibold text-blue-700 mb-3">Menu & Dishes</h3>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h3 className="text-lg font-semibold text-blue-700 mb-3">Financial Details</h3>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between border-t pt-2">
                      ...
                      <span className="font-medium text-blue-600">{formatCurrency(selectedEvent.downpaymentAmount || selectedEvent.downpayment_amount || 0)}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                {(selectedEvent.id_upload || selectedEvent.customer_id_url) && (
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="text-lg font-semibold text-blue-700 mb-3">Uploaded ID</h3>
                    <div>
      ...
      {showAddModal && canAdd && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white text-black p-6 rounded-lg shadow-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto relative">
            ...
            <h2 className="text-2xl font-bold mb-4 text-blue-700 border-b pb-2">Add New Event</h2>
            <div className="flex flex-col md:flex-row gap-6">
              <div className="md:w-1/3 border-r pr-4">
                <h3 className="text-lg font-semibold mb-3 text-blue-700">Select Package</h3>
                <div className="space-y-3">
                  {packages.map((pkg) => (
                    ...
                    >
                      ...
                      <p className="text-blue-600">₱{parseFloat(pkg.price.replace(/[^\d.]/g, '')).toFixed(2)}</p>
                ...
                {selectedPackage && (
                  <div className="mt-4">
                    <h3 className="text-lg font-semibold mb-3 text-blue-700">Select Set</h3>
                    <div className="space-y-3">
                      {sets.map((set) => (
                        <div
                          key={set.name}
                        ...
                        >
                          ...
                          <p className="text-blue-600">₱{set.price.toFixed(2)}</p>
                  ...
                  {newEvent.bookedBy && !showCustomerLookup && (
                    <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-blue-900 font-medium">Loaded: {newEvent.bookedBy}</span>
                      </div>
                      <button
                        type="button"
                        onClick={() => {
      ...
      {showEditModal && selectedEvent && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white text-black p-6 rounded-lg shadow-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto relative">
            ...
            <h2 className="text-2xl font-bold mb-6 text-blue-700">Edit Reservation</h2>
            <div className="flex flex-col md:flex-row gap-6">
              <div className="md:w-1/3">
                ...
                <div className="grid grid-cols-1 gap-3 max-h-96 overflow-y-auto">
                  {packages.map((pkg) => (
                    <div
                      key={pkg.id}
                      className={`p-3 border rounded cursor-pointer ${selectedPackage?.id === pkg.id ? "bg-blue-100" : "bg-white"
                        }`}
                      onClick={() => {
                        setSelectedPackage(pkg);
                        setSelectedDishes([]);
                    ...
                    >
                      <h4 className="font-bold text-gray-700">{pkg.name}</h4>
                      <p className="text-blue-600">₱{parseFloat(pkg.price).toFixed(2)}</p>
                    </div>
                  ))}
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {sets.map((set) => (
                    <div
                      key={set.name}
                      className={`p-3 border rounded cursor-pointer ${selectedSet?.name === set.name ? "bg-blue-100" : "bg-white"
                        }`}
                      onClick={() => {
                        setSelectedSet(set);
                        setSelectedDishes([]);
      ...
      {showSignaturePopup && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            <h2 className="text-xl font-bold mb-4 text-blue-700">E-Signature</h2>
            <canvas
              ref={canvasRef}
      ...
      {showCameraPopup && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            <h2 className="text-xl font-bold mb-4 text-blue-700">Capture Customer ID</h2>
            {cameraError ? (
      ...
      {showCollectPaymentModal && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            <h2 className="text-xl font-bold mb-4 text-blue-700">Collect Outstanding Payment</h2>
