...
const HousekeepingTable = ({
  ...
  const validRooms = rooms.filter(room => room.id != null);
            ...
            <div className="hidden md:block">
              <table className="w-full border-collapse">
                ...
                <tbody>
                  {validRooms.length === 0 ? (
                    <tr>
                      <td colSpan="5" className="p-3 text-center text-black dark:text-black">
                      ...
                      >
                        ...
                        <td className="p-3">
                          <input
                            ...
                            className={`p-2 border rounded w-full text-black focus:ring-2 focus:ring-green-500 dark:bg-gray-300 dark:text-black dark:border-black dark:focus:ring-green-400 ${
                              isLoading ? 'opacity-50 cursor-not-allowed' : ''
                            }`}
