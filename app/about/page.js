    ...
    <main className="min-h-screen bg-white py-12 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4">
          <Image src="/Joannaslogo.png" alt="Joanna&apos;s Logo" width={72} height={72} />
          <h1 className="text-3xl font-bold">About Joanna&apos;s Hotel</h1>
        </div>

        <section className="mt-8 bg-gray-20 border rounded-lg p-6">
          <h2 className="text-2xl font-semibold mb-3">Our History</h2>
          <p className="text-gray-700 mb-4">
            Joanna&apos;s Hotel started as a small family-run guesthouse with a single set of rooms and a commitment to warm,
            personalized service. Over the years, Joanna&apos;s grew thanks to loyal guests and a reputation for hospitality.
          ...
          <p className="text-gray-700 mb-4">
            Today, Joanna&apos;s Hotel blends classic hospitality with modern convenience. Our team continues Joanna&apos;s legacy of
